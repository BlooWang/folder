...
title 其它设置
echo   =====================================================================
echo                        Windows 10 其它设置                  
echo   =====================================================================
echo.
echo   > 关闭蓝牙：
echo       WIN10设置---设备(蓝牙、打印机、鼠标)--蓝牙，关闭即可
echo   > 关闭自动播放:
echo       WIN10设置---设备(蓝牙、打印机、鼠标)--自动播放，关闭即可
echo   > 用户账户控制
echo       控制面板 ---用户账户---更改用户账户控制
echo   >  疑难解答
echo       控制面板 ---疑难解答---左侧更改设置
echo   > 安全和维护消息提示
echo       控制面板---安全和维护--左侧安全和维护设置
echo   > Windows SmartScreen筛选器
echo       控制面板---安全和维护--左侧更改Windows SmartScreen筛选器
echo.
echo   VMware Workstation 12序列号: 5A02H-AU243-TZJ49-GTC7K-3C61N
echo.
echo   AIDA64Extreme序列号：ULUG1-PRWD6-U8DA7-8DMM4-FUYR8
echo.
echo   3dmark 高级版: 3DM-ICF-3DK7M-UHUP2-9LSSH-CJQCD
echo.
echo   软碟通 用户名：王涛 注册码：7C81-1689-4046-626F
echo.
echo  【R】返回                           【E】退出
echo.
set /p oth=请输入选择的对应的编号:
...
echo.
echo  【3】数字许可证激活（已经数字激活的不要点可能会出莫名其妙的问题）
echo.     
echo   家庭版升级专业版密钥：VK7JG-NPHTM-C97JM-9MPGT-3V66T
echo.
echo  【R】返回                            【E】退出
echo.
